...
WIDGETS = {
	...
	'stopStatus': { 'type':'ttext', 'format':'STOP', 'font':'GraphikSemibold20', 'varwidth':True, 'just':'center', 'size':(128,28) },
	'ttime': { 'type':'ttext', 'format':'{0}', 'variables':['localtime'], 'font':'GraphikThin28', 'just':'center', 'varwidth':False, 'size':(128,28) },
}

...
WIDGETS = {
	...
	'samplerate': { 'type':'ttext', 'format':'{0}', 'variables':['samplerate'], 'font':'GraphikRegular12', 'just':'center','varwidth':True, 'size':(80,12)},
...
CANVASES = {
	...
	'playing': { 'widgets': [ ('artist',0,20) , ('bitdepth',0,52), ('encoding',48,52), ('samplerate',48,52)], 'size':(128,64) },

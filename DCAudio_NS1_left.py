...
WIDGETS = {
	...
	'samplerate': { 'type':'ttext', 'format':'{0}', 'variables':['samplerate'], 'font':'GraphikRegular12', 'just':'center','varwidth':True,'size':(60,8)},
...
CANVASES = {
	...
	'playing': { 'widgets': [ ('artist',0,20) , ('bitdepth',0,52), ('samplerate',30,52) , ('encoding',80,52)], 'size':(128,64) },

...
WIDGETS = {
	...
	'samplerate': { 'type':'ttext', 'format':'{0}', 'variables':['samplerate'], 'font':'GraphikRegular12', 'just':'center','varwidth':True,'size':(38,8)},
	'encoding': { 'type':'ttext', 'format':'{0}', 'variables':['encoding|capitalize'], 'font':'GraphikRegular12', 'just':'right','varwidth':True,'size':(38,8)},
}
...
CANVASES = {
	...
	'playing': { 'widgets': [ ('artist',0,20) , ('bitdepth',0,52), ('samplerate',40,52) , ('encoding',88,52)], 'size':(128,64) },

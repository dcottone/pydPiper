...
WIDGETS = {
	...
	'bitdepth': { 'type':'ttext', 'format':'{0}', 'variables':['bitdepth'], 'font':'GraphikRegular12', 'just':'center','varwidth':True},
	'samplerate': { 'type':'ttext', 'format':'{0}', 'variables':['samplerate'], 'font':'GraphikThin12', 'just':'center','varwidth':True},
}
...
CANVASES = {
	...
	'playing': { 'widgets': [ ('artist',0,23) , ('bitdepth',0,52), ('samplerate',40,52)], 'size':(128,64) },

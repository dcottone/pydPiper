...
WIDGETS = {
	...
	'encoding': { 'type':'ttext', 'format':'{0}', 'variables':['encoding|upper'], 'font':'GraphikRegular12', 'just':'right','varwidth':True},
}
...
CANVASES = {
	...
	'playing': { 'widgets': [ ('artist',0,20) , ('bitdepth',0,52), ('samplerate',30,52) , ('encoding',80,0)], 'size':(128,64) },
